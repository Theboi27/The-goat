...
const CHARACTERS = {
  ...
  julias: {
    ...
    visual: {
      ...
      mask: 'cowl', eyes: { glow: '#eafcff' }, gloves: true, aura: null,
      suit: { torso: '#14181f', arms: '#181d26', legs: '#11151b', boots: '#232a36', gloves: '#1d242f', belt: '#3a4759' },
      emblem: { type: 'shieldbolt', color: '#9fe7ff', glow: true },
      cape: { color: '#0d1117', len: 60 },
    },
  ...
  tecton: {
    ...
    visual: {
      skin: '#7a513a', build: 0.85, heightScale: 1.06,
      mask: 'none', hair: { style: 'bald', color: '#222' }, eyes: { glow: '#b5e07d' }, gloves: false,
      suit: { torso: '#5d4a33', arms: '#6b5435', legs: '#4e3f2c', boots: '#3d3225', gloves: '#6b5435', belt: '#8a6a3a' },
      emblem: { type: 'leaf', color: '#9fcc6a', glow: true },
